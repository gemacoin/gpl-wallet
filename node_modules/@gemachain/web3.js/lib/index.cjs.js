...
class Struct {
  ...
  encode() {
    return buffer.Buffer.from(borsh.serialize(GEMACHAIN_SCHEMA, this));
  }

  static decode(data) {
    return borsh.deserialize(GEMACHAIN_SCHEMA, this, data);
  }

  static decodeUnchecked(data) {
    return borsh.deserializeUnchecked(GEMACHAIN_SCHEMA, this, data);
  }
...
function makeWebsocketUrl(endpoint) {
  ...
  // we're directly trying to connect to gemcachain-validator's ws listening port.
...
class Connection {
   ...
   *
   * ```typescript
   * import { Connection, PublicKey, CARATS_PER_SOL } from "@gemcachain/web3.js";
   *
   * (async () => {
   *   const connection = new Connection("https://api.testnet.solana.com", "confirmed");
   *   const myAddress = new PublicKey("2nr1bHFT86W9tGnyvmYW4vcHKsQB3sVQfnddasz4kExM");
   *   const signature = await connection.requestAirdrop(myAddress, CARATS_PER_SOL);
...
const CARATS_PER_SOL = 1000000000;
...
exports.CARATS_PER_SOL = CARATS_PER_SOL;
...
exports.GEMACHAIN_SCHEMA = GEMACHAIN_SCHEMA;
